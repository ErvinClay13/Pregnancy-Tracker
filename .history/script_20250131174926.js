...
function trackPregnancy() {
    ...
    const daysInCurrentWeek = diffInDays % 7; // The remaining days within the current week

    // Display the results
    updateResults(currentWeek, daysInCurrentWeek);
    updateImages(currentWeek);
    updateButtons();
}
...
function updateResults() {
    const daysInCurrentWeek = (currentWeek * 7); // Multiply weeks by 7 to get days
    const days = daysInCurrentWeek % 7; // Days within the current week
