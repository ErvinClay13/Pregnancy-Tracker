...
let currentWeek = 0; // Keeps track of the current week
const trackerBtn = document.getElementById("trackerBtn");
...
function changeWeekBy(offset) {
    ...
    updateResults();
    updateImages(); // Update images accordingly

    // Handle button visibility
    document.getElementById("prevWeek").style.display = currentWeek <= 0 ? "none" : "block";
    document.getElementById("nextWeek").style.display = currentWeek >= MAX_WEEKS ? "none" : "block";
}
...
function updateImages() {
    const babyImages = [
        "./babySizes/bsWeek0.png", "./babySizes/bsWeek1.png", "./babySizes/bsWeek2.jpg",
        "./babySizes/bsWeek3.jpg", "./babySizes/bsWeek4.jpg", "./babySizes/bsWeek5.jpg",
        "./babySizes/bsWeek6.jpg", "./babySizes/bsWeek7.jpg", "./babySizes/bsWeek8.jpg",
        "./babySizes/bsWeek9.jpg", "./babySizes/bsWeek10.jpg", "./babySizes/bsWeek11.jpg",
        "./babySizes/bsWeek12.jpg", "./babySizes/bsWeek13.jpg", "./babySizes/bsWeek14.jpg",
        "./babySizes/bsWeek15.jpg", "./babySizes/bsWeek16.jpg", "./babySizes/bsWeek17.jpg",
        "./babySizes/bsWeek18.jpg", "./babySizes/bsWeek19.jpg", "./babySizes/bsWeek20.jpg",
        "./babySizes/bsWeek21.jpg", "./babySizes/bsWeek22.jpg", "./babySizes/bsWeek23.jpg",
        "./babySizes/bsWeek24.jpg", "./babySizes/bsWeek25.jpg", "./babySizes/bsWeek26.jpg",
        "./babySizes/bsWeek27.jpg", "./babySizes/bsWeek28.jpg", "./babySizes/bsWeek29.jpg",
        "./babySizes/bsWeek30.jpg", "./babySizes/bsWeek31.jpg", "./babySizes/bsWeek32.jpg",
        "./babySizes/bsWeek33.jpg", "./babySizes/bsWeek34.jpg", "./babySizes/bsWeek35.jpg",
        "./babySizes/bsWeek36.jpg", "./babySizes/bsWeek37.jpg", "./babySizes/bsWeek38.jpg",
        "./babySizes/bsWeek39.jpg", "./babySizes/bsWeek40.jpg"
    ];

    document.getElementById("imgChange").src = babyImages[currentWeek] || "./defaultImage.jpg";
}

document.getElementById("prevWeek").addEventListener("click", () => changeWeekBy(-1));
document.getElementById("nextWeek").addEventListener("click", () => changeWeekBy(1));
